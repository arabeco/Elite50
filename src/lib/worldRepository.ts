...
const mapManagerRow = (worldId: string, manager: Manager) => ({
  ...
  origin_district: manager.originDistrict || manager.district,
...
const mapTeamRow = (worldId: string, team: Team) => ({
  ...
  origin_district: team.originDistrict || team.district,
  league: team.league,
...
const mapPlayerRow = (worldId: string, player: Player) => ({
  ...
  origin_district: player.originDistrict || player.district,
